...
namespace ggraf
{
    ...
    public:
        ...
        void* loadVertexToBranchMap(std::string filename, size_t w, size_t h, size_t slices);
        size_t saveVertexToBranchMap(std::string filename, size_t w, size_t h, size_t slices, unsigned int* branch_map);
