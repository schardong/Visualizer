...
namespace ggraf
{
    ...
    public:
        ...
        unsigned short* loadVertexToBranchMap(std::string filename, size_t w, size_t h, size_t slices);
        size_t saveVertexToBranchMap(std::string filename, size_t w, size_t h, size_t slices, unsigned short* branch_map);

        unsigned char* loadTransferFunction(std::string filename, size_t bytes_per_pixel);
        ...
        GLuint createVertexBranchTex(size_t w, size_t h, size_t slices, unsigned short* data);
        ...
        bool uploadVertexBranchData(size_t w, size_t h, size_t slices, unsigned short* data, GLuint texId);
        ...
        void* getVolumeData(size_t w, size_t h, size_t slices, size_t bytes_per_pixel, GLuint texId);
        unsigned short* getVertexBranchData(size_t w, size_t h, size_t slices, GLuint texId);
        unsigned char* getTransferFuncData(size_t bytes_per_pixel, GLuint texId);
        unsigned char* getMultiDimTransferFuncData(size_t w, size_t h, size_t bytes_per_pixel, GLuint texId);
        unsigned char* getColorTransferFuncData(size_t bytes_per_pixel, GLuint texId);
